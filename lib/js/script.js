...
$(window).scroll(function () {
    ...
    if (wScroll > welcome - 70) {
        $('.welcome-right').addClass("show");
    }
...
$(document).ready(function () {
    alert('This web is only showing a STATIC WEBSITE (HTML, CSS, and Javascript). To see full version or DYNAMIC WEBSITE (with PHP & Databases) please contact the project/repository owner')
});